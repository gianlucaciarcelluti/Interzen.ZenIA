...
**Applicabilità**: OBBLIGATORIO per tutti gli SP - SP39 è parte della trasformazione digitale PA
...
**Applicabilità**: CRITICA per SP39 - gestisce dati personali
...
**Nota**: Dettagli di conformità completi nella sezione "## 🏛️ Conformità Normativa - SP39
