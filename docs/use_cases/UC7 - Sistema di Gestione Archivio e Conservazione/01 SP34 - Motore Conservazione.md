...
## 🏛️ Conformità Normativa - SP34

### 1. Quadro Normativo di Riferimento

**Framework applicabili a SP34 (Motore Conservazione)**:
...
**Applicabilità**: OBBLIGATORIO per tutti gli SP - SP34 è parte della trasformazione digitale PA
...
**Applicabilità**: CRITICA per SP34 - gestisce dati personali
...
**Nota**: Dettagli di conformità completi nella sezione "## 🏛️ Conformità Normativa - SP34
