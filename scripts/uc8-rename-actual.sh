...
# UC8 File Renaming - ACTUAL EXECUTION
# Date: 2025-11-20
...
cat > /tmp/uc8_renames.txt << 'EOF'
00 Architettura UC8.md|00-ARCHITECTURE.md
01 Sequence diagrams.md|03-SEQUENCES.md
02 Matrice Dipendenze.md|02-DEPENDENCIES.md
Guida_UC8_SIEM_Sicurezza.md|04-GUIDE.md
EOF

echo "📝 Files to rename:"
while IFS='|' read -r old_name new_name; do
    echo "   $old_name → $new_name"
done < /tmp/uc8_renames.txt
echo ""
