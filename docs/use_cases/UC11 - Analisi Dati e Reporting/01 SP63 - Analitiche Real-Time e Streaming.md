...
## 🏛️ Conformità Normativa - SP63

### 1. Quadro Normativo di Riferimento

**Framework applicabili a SP63 (Real-Time Analytics)**:
...
**Applicabilità**: OBBLIGATORIO per tutti gli SP - SP63 è parte della trasformazione digitale PA
...
**Applicabilità**: CRITICA per SP63 - gestisce dati personali
...
**Nota**: Dettagli di conformità completi nella sezione "## 🏛️ Conformità Normativa - SP63
