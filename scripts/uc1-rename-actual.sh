...
# UC1 File Renaming - ACTUAL EXECUTION
# Date: 2025-11-20
...
cat > /tmp/uc1_renames.txt << 'EOF'
00 Architettura Generale UC1.md|00-ARCHITECTURE.md
01 Sequence - Document Processing Completo.md|03-SEQUENCES.md
01 Sequence - Overview Semplificato.md|03-SEQUENCES-SIMPLIFIED.md
01 Sequence - Ultra Semplificato.md|03-SEQUENCES-ULTRA-SIMPLIFIED.md
02 Matrice Dipendenze Sottoprogetti UC1.md|02-DEPENDENCIES.md
Guida_UC1_Sistema_Gestione_Documentale.md|04-GUIDE.md
EOF

echo "📝 Files to rename:"
while IFS='|' read -r old_name new_name; do
    echo "   $old_name → $new_name"
done < /tmp/uc1_renames.txt
echo ""
...
echo "✅ Found: $files_found / 6 files"
...
echo "✅ Renamed: $files_renamed / 6 files"
echo ""
...
if [ "$renamed_verified" -eq 6 ]; then
    ...
    echo "⚠️  VERIFICATION FAILED — $((6 - renamed_verified)) files not found"
    exit 1
fi
