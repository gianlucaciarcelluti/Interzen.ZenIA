...
# UC10 File Renaming - ACTUAL EXECUTION
# Date: 2025-11-20
...
cat > /tmp/uc10_renames.txt << 'EOF'
00 Architettura UC10.md|00-ARCHITECTURE.md
02 Sequence Diagrams UC10.md|03-SEQUENCES.md
03 Dependency Matrix UC10.md|02-DEPENDENCIES.md
Guida_UC10_Supporto_Utente.md|04-GUIDE.md
EOF

echo "📝 Files to rename:"
while IFS='|' read -r old_name new_name; do
    echo "   $old_name → $new_name"
done < /tmp/uc10_renames.txt
echo ""
