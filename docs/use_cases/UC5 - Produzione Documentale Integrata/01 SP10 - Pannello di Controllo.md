...
**Applicabilità**: OBBLIGATORIO per tutti gli SP - SP10 è parte della trasformazione digitale PA
...
**Applicabilità**: CRITICA per SP10 - gestisce dati personali
...
**Applicabilità**: CRITICA per SP10 - ha interfaccia utente / interoperabilità
...
**Nota**: Dettagli di conformità completi nella sezione "## 🏛️ Conformità Normativa - SP10
