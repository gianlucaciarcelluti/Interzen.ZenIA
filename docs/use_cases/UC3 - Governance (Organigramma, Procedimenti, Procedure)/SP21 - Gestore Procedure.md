...
**Framework applicabili a SP21 (Gestore Procedure)**:
...
- **Document Crittografia**: Crittografia contenuti sensibili
- **Controllo Accesso**: Granular permissions per procedura
