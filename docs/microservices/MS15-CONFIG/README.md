...
### Che cos'è MS15-CONFIG?
MS15-CONFIG fornisce funzionalità di gestione della configurazione per la piattaforma ZenIA.

### Responsabilità principali
- Funzionalità core secondo le specifiche architetturali
- Integrazione con gli altri microservizi
- Gestione e distribuzione delle configurazioni
- Supporto per monitoraggio e logging
