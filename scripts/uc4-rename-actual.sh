...
# UC4 File Renaming - ACTUAL EXECUTION
# Date: 2025-11-20
...
cat > /tmp/uc4_renames.txt << 'EOF'
00 Architettura UC4.md|00-ARCHITECTURE.md
00 SP28-RESERVED.md|RESERVED-SP28.md
01 Sequence diagrams.md|03-SEQUENCES.md
02 Matrice Dipendenze.md|02-DEPENDENCIES.md
Guida_UC4_BPM.md|04-GUIDE.md
EOF

echo "📝 Files to rename:"
while IFS='|' read -r old_name new_name; do
    echo "   $old_name → $new_name"
done < /tmp/uc4_renames.txt
echo ""
...
echo "✅ Found: $files_found / 5 files"
...
echo "✅ Renamed: $files_renamed / 5 files"
echo ""
...
if [ "$renamed_verified" -eq 5 ]; then
    ...
    echo "⚠️  VERIFICATION FAILED — $((5 - renamed_verified)) files not found"
    exit 1
fi
