...
# UC11 File Renaming - ACTUAL EXECUTION
# Date: 2025-11-20
...
cat > /tmp/uc11_renames.txt << 'EOF'
00 Architettura UC11.md|00-ARCHITECTURE.md
02 Matrice Dipendenze.md|02-DEPENDENCIES.md
Guida_UC11_Analisi_Dati_Reporting.md|04-GUIDE.md
EOF

echo "📝 Files to rename:"
while IFS='|' read -r old_name new_name; do
    echo "   $old_name → $new_name"
done < /tmp/uc11_renames.txt
echo ""
...
echo "✅ Found: $files_found / 3 files"
...
echo "✅ Renamed: $files_renamed / 3 files"
echo ""
...
if [ "$renamed_verified" -eq 3 ]; then
    ...
    echo "⚠️  VERIFICATION FAILED — $((3 - renamed_verified)) files not found"
    exit 1
fi
