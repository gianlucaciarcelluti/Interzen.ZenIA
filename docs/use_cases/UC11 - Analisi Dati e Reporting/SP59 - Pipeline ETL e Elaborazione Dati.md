...
graph TB
    ...
    MON2 --> DQ4
```
## 🏛️ Conformità Normativa - SP59

### 1. Quadro Normativo di Riferimento

**Framework applicabili a SP59 (ETL Pipelines)**:
...
**Applicabilità**: OBBLIGATORIO per tutti gli SP - SP59 è parte della trasformazione digitale PA
...
**Applicabilità**: CRITICA per SP59 - gestisce dati personali
...
**Nota**: Dettagli di conformità completi nella sezione "## 🏛️ Conformità Normativa - SP59
